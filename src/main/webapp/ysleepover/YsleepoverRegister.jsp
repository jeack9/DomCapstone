...
<%
 /**
  * @Class Name : YsleepoverRegister.jsp
  * @Description : Ysleepover Register 화면
...
<c:set var="registerFlag" value="${empty ysleepoverVO.id ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="ysleepoverVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/ysleepover/YsleepoverList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/ysleepover/deleteYsleepover.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/ysleepover/addYsleepover.do' : '/ysleepover/updateYsleepover.do'}"/>";
    frm.submit();
...
<form:form commandName="ysleepoverVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>startdate</th>
			<td>
				<form:input path="startdate" cssClass="txt"/>
		...
		<tr>
			<th>applydate</th>
			<td>
				<form:input path="applydate" cssClass="txt"/>
				&nbsp;<form:errors path="applydate" />
			</td>
		</tr>	
		<tr>
			<th>reason</th>
			<td>
				<form:input path="reason" cssClass="txt"/>
