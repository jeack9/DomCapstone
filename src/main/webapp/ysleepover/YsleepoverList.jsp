...
<%
 /**
  * @Class Name : YsleepoverList.jsp
  * @Description : Ysleepover List 화면
...
function fn_egov_select(id) {
    document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/ysleepover/updateYsleepoverView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/ysleepover/addYsleepoverView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/ysleepover/YsleepoverList.do'/>";
   	document.getElementById("listForm").submit();
}
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.id}"/>')"><c:out value="${result.id}"/></a>&nbsp;</td>
								...
								<td align="center" class="listtd"><c:out value="${result.applydate}"/>&nbsp;</td>
								<td align="center" class="listtd"><c:out value="${result.reason}"/>&nbsp;</td>
									</tr>
			</c:forEach>
		</table>
	</div>
