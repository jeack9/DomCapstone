...
<%
 /**
  * @Class Name : YnoticeRegister.jsp
  * @Description : Ynotice Register 화면
...
<c:set var="registerFlag" value="${empty ynoticeVO.id ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="ynoticeVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/ynotice/YnoticeList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/ynotice/deleteYnotice.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/ynotice/addYnotice.do' : '/ynotice/updateYnotice.do'}"/>";
    frm.submit();
...
<form:form commandName="ynoticeVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
