            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                ...
                <div class="row">
                  <div class="mb-4">
                    <div class="form-outline">
                      <input type="text" id="form3Example1m" class="form-control form-control-lg" onkeydown="return event.key !== ' ';" name="username"/>
                  ...
                  <div class="mb-4">
                    <div class="form-outline">
                      <div class="input-group">
						  <input type="text" class="form-control" onkeydown="return event.key !== ' ';" aria-label="Recipient's username" id="id" aria-describedby="button-addon2">
                ...
                <div class="row">
                  <div class="mb-4">
                    <div class="form-outline">
                      <input type="password" id="pw" class="form-control form-control-lg"  onkeydown="return event.key !== ' ';" name="userpw" />
                      <label class="form-label" for="form3Example1m" id="pwCheckView">비밀번호</label>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="mb-4">
                    <div class="form-outline">
                      <input type="password" id="pwCheck" class="form-control form-control-lg" onkeydown="return event.key !== ' ';"/>
                      <label class="form-label" for="form3Example1m" id="pwCheckedView">비밀번호 확인</label>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col mb-3">
                    <div class="form-outline">
                      <input type="number" pattern="[0-9]*" title="숫자만 입력하세요." id="form3Example1n1" class="form-control form-control-lg" onkeydown="return event.key !== ' ';" oninput="javascript: if (this.value.length > 4) this.value = this.value.slice(0, 4);" name="phone2"/>
                    </div>
                  </div>
                   <div class="col-1 mb-3">
                    <h1>-</h1>
                   ...
                   <div class="col mb-3">
                    <div class="form-outline">
                      <input type="number" pattern="[0-9]*" title="숫자만 입력하세요." id="form3Example1n1" class="form-control form-control-lg " onkeydown="return event.key !== ' ';"  oninput="javascript: if (this.value.length > 4) this.value = this.value.slice(0, 4);" name="phone3"/>
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example8" class="form-control form-control-lg " onkeydown="return event.key !== ' ';" name="useraddr"/>
                ...
                <div class="d-flex justify-content-end pt-3">
                  <button type="button" class="btn btn-light btn-lg" onclick="location.href='/signin.jsp'">돌아가기</button>
                  <button type="button" class="btn btn-warning btn-lg ms-2" onclick="joinUser();">가입하기</button>
                </div>
