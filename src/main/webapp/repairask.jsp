...
<body>
   ...
   <!-- Navbar Start -->
    ...
    <form action="/yrepairask/addYrepairask.do" name="yaskfrm" >    
    <div id="main-container" style="padding: 0 12px; border-top: 2px solid black;">    	
        <div class="row">
            <div class="item1">문의번호</div>
            <div class="item2"><input type="text" id="reno" name="reno" value="${param.reno}" readonly style="background:#E8ECF4;"></div>
        </div>
        <div class="row">
            <div class="item1">문의내용</div>
            <div class="item2">
            <!-- <textarea id="" style="padding: 10px; min-height: 250px; width: 80%;"></textarea> -->
	            <div class="question-content content">
	                <div class="question-icon">Q</div>
	                <p style="width: 90%; white-space: pre-wrap; word-wrap: break-word; text-align: left; padding-left: 30px;"><b>${repair.content}</b></p>
	            </div>
            </div>
        </div>
        <div class="row">
            <div class="item1">답변</div>
            <div class="item2">
                <textarea name="content" id="content" style="padding: 10px; min-height: 250px; width: 80%;"></textarea>
            </div>
        </div>
    </div>
    ...
    <div style="text-align: center; padding-top: 20px;">
        <button type="button" id="submit_btn" class="btn btn-primary" style="padding: 10px 30px;">답변</button>
