            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="payment.jsp" class="dropdown-item">결제테스트</a>
                        <a href="freeboard.jsp" class="dropdown-item">게시판테스트</a>
                    </div>
                </div>
...
function signincheck(){//로그인 버튼 누르면 호출
	...
	<div style="text-align:center;">
		<form action ="/testuser/checkUserLogin.do" id="memberloginfrm" name="memberloginfrm" target="ABC">
                      <br />
                      <div>
                        <input
                          id="signinid"
