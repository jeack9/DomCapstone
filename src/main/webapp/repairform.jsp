...
<body>
   ...
   <!-- Navbar Start -->
    ...
    <form action="/yrepair/addYrepair.do" name="yrepairfrm" >
    <div id="main-container" style="padding: 0 12px; border-top: 2px solid black;">
        <div class="row">
            <div class="item1">호실</div>
            <div class="item2"><input type="text" id="roomnum" name="roomnum" placeholder="호실"></div>
        </div>
        <div class="row">
            <div class="item1">제목</div>
            <div class="item2"><input type="text" id="subject" name="subject" placeholder="제목"></div>
        </div>
        <div class="row">
            <div class="item1">작성자</div>
            <div class="item2"><input type="text" id="writer" name="writer" placeholder="작성자"></div>
        </div>
        <div class="row" style="display: flex;">
            <div class="item1">학번</div>
            <div class="item2"><input type="text" name="userid" value="${sessionScope.loginedUserVO.userid}" readonly></div>
        </div>
        <div class="row">
            <div class="item1">문의내용</div>
            <div class="item2">
                <textarea name="content" id="" style="padding: 10px; min-height: 250px; width: 80%;"></textarea>
            </div>
        </div>
    </div>
    ...
    <div style="text-align: center; padding-top: 20px;">
        <button type=button id="submit_btn" class="btn btn-primary" style="padding: 10px 30px;">등록</button>
