...
<body>
    ...
    <!-- Testimonial End -->
        ...
        <%YnoticeVO selectedVO = (YnoticeVO) request.getAttribute("selectedVO"); %>
    ...
    function saveJson(content, subject, onlytext, bno) {
  	   $.ajax({
  	       url:"/ynotice/updateYnotice.do", //request 보낼 서버의 경로
  	       type:'post', // 메소드(get, post, put 등)
  	       data: {'content': content, 'subject' : subject, 'onlytext' : onlytext, 'id' : bno},
  	       dataType: "text",
  	       async : false,
  	       success: function(data) {
  	    	  alert("수정완료");
  	    	 location.href = '/ynotice/YnoticeList.do'
  	       },
  	       error: function(err) {
  	    	   alert('에러났어요!!');
  	       }
