...
<%
 /**
  * @Class Name : YpaymentList.jsp
  * @Description : Ypayment List 화면
...
function fn_egov_select(pno) {
    document.getElementById("listForm").pno.value = pno;
   	document.getElementById("listForm").action = "<c:url value='/ypayment/updateYpaymentView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/ypayment/addYpaymentView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/ypayment/YpaymentList.do'/>";
   	document.getElementById("listForm").submit();
}
