...
<%
 /**
  * @Class Name : PaymentRegister.jsp
  * @Description : Payment Register 화면
...
<c:set var="registerFlag" value="${empty paymentVO.pno ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="paymentVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/payment/PaymentList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/payment/deletePayment.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/payment/addPayment.do' : '/payment/updatePayment.do'}"/>";
    frm.submit();
...
<form:form commandName="paymentVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>pno</th>
			<td>
				<form:input path="pno" cssClass="txt"/>
				&nbsp;<form:errors path="pno" />
			</td>
		</tr>	
		<tr>
			<th>username</th>
		...
		<tr>
			<th>roomtype</th>
			<td>
				<form:input path="roomtype" cssClass="txt"/>
		...
		<tr>
			<th>pdate</th>
			<td>
				<form:input path="pdate" cssClass="txt"/>
