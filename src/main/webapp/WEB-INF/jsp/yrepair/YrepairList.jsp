...
<%
 /**
  * @Class Name : YrepairList.jsp
  * @Description : Yrepair List 화면
...
function fn_egov_select(reno) {
    document.getElementById("listForm").reno.value = reno;
   	document.getElementById("listForm").action = "<c:url value='/yrepair/updateYrepairView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/yrepair/addYrepairView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/yrepair/YrepairList.do'/>";
   	document.getElementById("listForm").submit();
}
...
<div id="content_pop">
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								<th align="center">Reno</th>
								<th align="center">Roomnum</th>
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.reno}"/>')"><c:out value="${result.reno}"/></a>&nbsp;</td>
								<td align="center" class="listtd"><c:out value="${result.roomnum}"/>&nbsp;</td>
