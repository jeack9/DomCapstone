...
<%
 /**
  * @Class Name : YrepairRegister.jsp
  * @Description : Yrepair Register 화면
...
<c:set var="registerFlag" value="${empty yrepairVO.reno ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="yrepairVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/yrepair/YrepairList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/yrepair/deleteYrepair.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/yrepair/addYrepair.do' : '/yrepair/updateYrepair.do'}"/>";
    frm.submit();
...
<form:form commandName="yrepairVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			<th>reno</th>
			<td>
				<form:input path="reno" cssClass="txt"/>
				&nbsp;<form:errors path="reno" />
			</td>
		</tr>	
		<tr>
			<th>roomnum</th>
			<td>
				<form:input path="roomnum" cssClass="txt"/>
				&nbsp;<form:errors path="roomnum" />
			</td>
		</tr>	
		<tr>
			<th>subject</th>
