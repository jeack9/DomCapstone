...
/**
 * @Class Name : YrepairMapper.java
 * @Description : Yrepair Mapper Class
...
@Mapper("yrepairMapper")
public interface YrepairMapper {
	 ...
	 * @exception Exception
	 */
    public void insertYrepair(YrepairVO vo) throws Exception;
