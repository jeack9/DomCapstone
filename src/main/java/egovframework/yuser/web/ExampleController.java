...
public class ExampleController {
    ...
    public ExampleController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSJEUPLGSVMGJAJ", "9OGVVHKOH9CJGUABJ5H5IR4JJ4PFHYS9", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne(String phone, String rand) {
        Message message = new Message();
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        message.setFrom("01090002558");//발신번호 (coolsms 개인설정에 등록된 발신번호만 써야함,현재 내 폰번 1개니까 수정 ㄴㄴ)
        message.setTo(phone);//수신번호
        message.setText("본인확인을 위해 인증번호[" +rand+ "]\n를 입력해 주세요.");//메세지
